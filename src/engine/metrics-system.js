...
export function createMetricsState(overrides = {}) {
  const o = overrides ?? {}; // guard against null (createGlobalState initialises metrics: null)
  return {
    influence: o.influence ?? DEFAULT_VALUE,
    stability: o.stability ?? DEFAULT_VALUE,
    economic:  o.economic  ?? DEFAULT_VALUE,
    support:   o.support   ?? DEFAULT_VALUE,
  };
}
